...
BUCKETPT(){ read -p "WASABI Bucket : " s3path ; read -p "File on IFS:" ifsfile; $S3CMD cp $ifsfile $s3path ;LINE;}                          
BUCKETGT(){ read -p "WASABI Source file : " s3object; read -p "Target directory on IFS:" ifsfile; $S3CMD cp $s3object $ifsfile ;LINE;}
BUCKETDL(){ read -p "WASABI Source file : " s3object; $S3CMD  rm $s3object 2>&1 ;LINE;}                                     
 ASKLIB1(){ read -p "Library name: " libname; read -p "WASABI Bucket: " s3path; ifsfile=$IFSPATH/$libname.7z ;} 
...
#***********************************************************************************#                             
    ...
    HEAD(){ DRAW                                                                      
           ...
           WRITE;MARK;TPUT 4 5                                                                                                  
           $E "      WASABI CLOUD BACKUP MENU            ";UNMARK;}                                                            
  ...
  ARROW(){ read -s -n3 key 2>/dev/null >&2                                                                                
     ...
     M0(){ TPUT  7 11; $e "List content on WASABI        ";}                                                               
     M1(){ TPUT  8 11; $e "Upload file to WASABI         ";}                                                               
     M2(){ TPUT  9 11; $e "Get file from WASABI          ";}                                                              
     M3(){ TPUT 10 11; $e "Delete file from WASABI       ";}                                                              
     M4(){ TPUT 11 11; $e "Save Library to WASABI        ";}                                                                    
     M5(){ TPUT 12 11; $e "Save ALL Libraries to WASABI  ";}                                                               
     M6(){ TPUT 13 11; $e "List library saved on WASABI  ";}
